        ...
        <div className="p-4 md:p-8">
          ...
          <div className="max-w-6xl mx-auto py-12">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Link href="/courses/a1" className="bg-slate-800 p-6 rounded-xl border border-slate-700 hover:border-amber-400 transition cursor-pointer block">
              ...
              <Link href="/courses/a2" className="bg-slate-800 p-6 rounded-xl border border-slate-700 hover:border-amber-400 transition cursor-pointer block">
              ...
              <Link href="/courses/b1" className="bg-slate-800 p-6 rounded-xl border border-slate-700 hover:border-amber-400 transition cursor-pointer block">
              ...
              <Link href="/courses/b2" className="bg-slate-800 p-6 rounded-xl border border-slate-700 hover:border-amber-400 transition cursor-pointer block">
              ...
              <Link href="/courses/c1" className="bg-slate-800 p-6 rounded-xl border border-slate-700 hover:border-amber-400 transition cursor-pointer block">
              ...
              <Link href="/courses/c2" className="bg-slate-800 p-6 rounded-xl border border-slate-700 hover:border-amber-400 transition cursor-pointer block">
